...
const AboutUs = () => {
    ...
    return (
        <section id="about" ref={containerRef} className="relative bg-white text-black px-[8%]">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row w-full mx-auto">
                ...
                <div ref={leftRef} className="w-full lg:w-[45%] h-screen sticky top-0 flex flex-col justify-center pr-6 lg:pr-12 py-20 z-10">
                    <div className="w-full text-left">
                        ...
                        <h2 className="heading-normal-case font-neutral text-4xl md:text-6xl leading-[1.15] mb-6 text-[#2B3838] tracking-tight">
