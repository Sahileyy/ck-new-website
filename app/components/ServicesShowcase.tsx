...
export default function ServicesShowcase() {
  ...
  return (
    <section ref={sectionRef} id="services" className="w-full bg-white px-[4%] py-20 lg:px-[8%] lg:py-28">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-5">
          {services.map(([title, description, image], idx) => (
            <motion.article 
              ...
              className="group relative min-h-[350px] rounded-md overflow-hidden bg-slate-200 sm:min-h-[400px] lg:min-h-[488px]"
            >
