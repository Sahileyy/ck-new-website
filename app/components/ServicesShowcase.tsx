...
const services = [
  ...
  ["Search Engine Optimisation", "Help the right people discover your brand with search content and optimisation built for long-term visibility.", "/images/cards/seo.jpeg"],
] as const;
      ...
      <div className="w-full mx-auto">
        ...
        <div className="grid gap-6 pb-14 lg:grid-cols-[1.4fr_0.9fr] lg:items-end lg:pb-20">
          <div>
            ...
            <h2 className="text-4xl font-normal leading-[0.95] tracking-[-0.06em] text-slate-500 sm:text-4xl lg:text-5xl xl:text-6xl"> How We Drive Growth </h2>
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-5">
          {services.map(([title, description, image]) => (
            <article key={title} className="group relative min-h-[350px] rounded-sm  overflow-hidden bg-slate-200 sm:min-h-[400px] lg:min-h-[488px]">
